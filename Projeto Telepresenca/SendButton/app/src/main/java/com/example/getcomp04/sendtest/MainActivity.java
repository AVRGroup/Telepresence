...
//A transferencia de video foi feita com base num tutorial da RED5PRO que pode ser encontrado em:
//  https://www.red5pro.com/docs/streaming/android/
...
*/
   ...
   /* public void moveup(View v){ new Envio("w").execute("");}
    public void movedown(View v){new Envio("s").execute("");}
    public void moveleft(View v){new Envio("a").execute("");}
    public void moveright(View v){new Envio("d").execute("");}*/
 /*
    @Override
