    ...
    <div class="container main-container clear-fix">
      ...
      <div id="content-section">
        ...
        <div class="content-section-story">
          ...
          <strong>Visit the online documentation for <a class="link" href="https://www.red5pro.com/docs/server/autoscale/" target="_blank">Red5 Pro Autoscaling and Stream Manager</a>.</strong>
          ...
          <strong>Read More about Smart Autoscaling at:</strong><br><a class="link" style="text-decoration: underline;" href="https:/www.red5pro.com/docs/server/autoscale" target="_blank">Red5 Pro Autoscaling and Stream Manager</a>
          ...
          <br><a class="link" style="text-decoration: underline;" href="https:/www.red5pro.com/docs/server/streammanagerapi" target="_blank">Red5 Pro Stream Manager API</a>
          ...
          <br><a class="link" style="text-decoration: underline;" href="https:/www.red5pro.com/docs/server/streammanagerug" target="_blank">Red5 Pro Stream Manager User Guide</a>
